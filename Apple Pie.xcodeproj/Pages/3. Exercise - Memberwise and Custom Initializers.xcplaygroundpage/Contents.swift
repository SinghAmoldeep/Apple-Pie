...
var somePlace = GPS(lattitude: 51.514004, longitude: 0.125226)
print(somePlace)
...
var lap1 = Laptop(yearPurchased: 2021)
var lap2 = Laptop(screenSize: 15, repairCount: 0, yearPurchased: 2022)
...
struct Height {
    ...
    init (heightInCentimeters : Double){
        ...
        self.heightInInches = heightInCentimeters * 0.394
    }
...
var myHeight = Height(heightInInches: 75)
print(myHeight)
